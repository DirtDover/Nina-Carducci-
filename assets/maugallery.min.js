                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body" style="display:flex;justify-content:center;">
                            ...
                            ${e?'<button class="mg-next" style="border:none;cursor:pointer;position:absolute;top:50%;right:-15px;background:white;}">></button>':'<span style="display:none;" />'}
                        </div>
                    </div>
                </div>
